...
module.exports =
{
  parallel      : __nccwpck_require__(857),
  serial        : __nccwpck_require__(54),
  serialOrdered : __nccwpck_require__(961)
};
...
var defer = __nccwpck_require__(200);
...
var async = __nccwpck_require__(452)
  , abort = __nccwpck_require__(818)
  ;
...
var abort = __nccwpck_require__(818)
  , async = __nccwpck_require__(452)
  ;
...
var iterate    = __nccwpck_require__(902)
  , initState  = __nccwpck_require__(721)
  , terminator = __nccwpck_require__(351)
  ;
...
var serialOrdered = __nccwpck_require__(961);
...
var DelayedStream = __nccwpck_require__(710);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(830)("follow-redirects");
    }
    catch (error) { /* */ }
...
var Writable = (__nccwpck_require__(203).Writable);
var assert = __nccwpck_require__(613);
var debug = __nccwpck_require__(778);
...
var CombinedStream = __nccwpck_require__(630);
var util = __nccwpck_require__(23);
var path = __nccwpck_require__(928);
var http = __nccwpck_require__(611);
var https = __nccwpck_require__(692);
var parseUrl = (__nccwpck_require__(16).parse);
var fs = __nccwpck_require__(896);
var Stream = (__nccwpck_require__(203).Stream);
var mime = __nccwpck_require__(96);
var asynckit = __nccwpck_require__(324);
var populate = __nccwpck_require__(835);
...
var db = __nccwpck_require__(829)
...
const os = __nccwpck_require__(238);
const tty = __nccwpck_require__(18);
...
/* harmony import */ var _infisical_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(982);
/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(943);
...
try {
  ...
  switch (method) {
    case 'universal': {
      ...
      infisicalToken = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_1__/* .UALogin */ .mo)({
        domain,
        clientId: UAClientId,
    ...
    case 'oidc': {
      ...
      infisicalToken = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_1__/* .oidcLogin */ .NW)({
        domain,
        identityId,
        oidcAudience,
      });
  ...
  const keyValueSecrets = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_1__/* .getRawSecrets */ .s3)({
    domain,
    envSlug,
    infisicalToken,
    projectSlug,
  ...
  if (exportType === 'env') {
    ...
    try {
      ...
      await fs_promises__WEBPACK_IMPORTED_MODULE_2__.writeFile(filePath, fileContent);
    } catch (err) {
...
__nccwpck_require__.d(__webpack_exports__, {
  mo: () => (/* binding */ UALogin),
  s3: () => (/* binding */ getRawSecrets),
  NW: () => (/* binding */ oidcLogin)
});
...
var form_data = __nccwpck_require__(454);
...
var proxy_from_env = __nccwpck_require__(777);
...
var follow_redirects = __nccwpck_require__(573);
...
var external_stream_ = __nccwpck_require__(203);
...
var external_module_ = __nccwpck_require__(339);
...
;// CONCATENATED MODULE: ./infisical.js


const infisical_require = (0,external_module_.createRequire)(import.meta.url);
const core = infisical_require('@actions/core');


const UALogin = async ({ clientId, clientSecret, domain }) => {
  const loginData = external_querystring_namespaceObject.stringify({
    clientId,
    clientSecret,
  });
