...
/* harmony import */ var _infisical_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(1462);
...
try {
  ...
  switch (method) {
    case 'universal': {
      ...
      infisicalToken = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_0__/* .UALogin */ .mo)({
        domain,
        clientId: UAClientId,
    ...
    case 'oidc': {
      ...
      infisicalToken = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_0__/* .oidcLogin */ .NW)({
        domain,
        identityId,
        oidcAudience,
      });
  ...
  const keyValueSecrets = await (0,_infisical_js__WEBPACK_IMPORTED_MODULE_0__/* .getRawSecrets */ .s3)({
    domain,
    envSlug,
    infisicalToken,
    projectSlug,
  ...
  if (exportType === 'env') {
    ...
    try {
      ...
      await fs_promises__WEBPACK_IMPORTED_MODULE_1___default().writeFile(filePath, fileContent);
    } catch (err) {
...
const infisical_require = /* createRequire() */ undefined;
const core = infisical_require('@actions/core');


const UALogin = async ({ clientId, clientSecret, domain }) => {
  const loginData = external_querystring_default().stringify({
    clientId,
    clientSecret,
  });
